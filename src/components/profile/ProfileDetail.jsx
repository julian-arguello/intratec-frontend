...
function ProfileDetail() {
  ...
  return (
    <main>
      <h2 className="my-5 text-center text-sm-start">
        Perfil de {authRole(state.user.role.role_name)}
      </h2>
      <button
        className="btn-add btn-edit d-flex justify-content-center align-items-center"
      ...
      <div id="editForm" className="closeEditForm">
        <ProfileEdit function={toggleEditForm} />
      </div>
    </main>
  );
}
