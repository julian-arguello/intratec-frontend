...
export function ServiceItem(props) {
  return (
    <div className="col">
      <div
        className={stateClass(props.service.state) + ' card text-white p-sm-3'}
      >
        <div className="card-body">
          ...
          <div className="d-flex justify-content-between my-4">
            ...
            {!props.clientDetail && (
              <span class="text-box-card text-end">
          ...
          <div className="d-flex justify-content-between align-items-center mb-4">
            <div className="d-flex align-items-center">
              ...
              <span class="text-box-card">
                {props.service.user.name + ' ' + props.service.user.lastname}
              </span>
            </div>
            {/* {!props.clientDetail && (
          ...
          <div className="d-flex align-items-center mb-5">
            <span class="material-icons-outlined me-2">inventory_2</span>
            <span class="text-box-card">
          ...
          <div className="d-flex justify-content-between align-items-center">
            <div className="d-flex align-items-center">
              <small>
                Hace{' '}
                {formatDistance(new Date(props.service.create_at), new Date(), {
                  locale: es,
                })}
              </small>
            </div>
